    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try  {
            ...
            out.println("function dibujar(){"
                    ...
                    + "lapiz.drawImage(img, 5, 5);"
                    + "var img2 = new Image();"        
                    + "img2.src = \""+fabrica.crearArmadura().ubicacion()+"\";"                   
                    + "lapiz.drawImage(img2, 5, 150);"
                    + "var img3 = new Image();"
                    + "img3.src = \""+fabrica.crearEscudo().ubicacion()+"\";"                   
                    + "lapiz.drawImage(img3, 5, 80);"
                    + "var img4 = new Image();"
                    + "img4.src = \""+personaje.ubicacion()+"\";"                   
                    + "lapiz.drawImage(img4, 0, 0);"
                    
                    + "}");
            out.println("</script>");
            out.println("</head>");
            out.println("<body onfocus=\"dibujar();\">");
            
            
            
            out.println("<canvas onfocus=\"dibujar();\" height=\"800px\" width=\"200px\" id=\"micanvas\"></canvas>");
            out.println("</body>");
            out.println("</html>");
        }catch(Exception e){
